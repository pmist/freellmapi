...
/**
 * V9: Add DeepSeek models directly from deepseek.com
 */
function migrateModelsV9(db: Database.Database) {
  ...
  const additions: Array<[string, string, string, number, number, string, number | null, number | null, number | null, number | null, string, number | null]> = [
    ['deepseek', 'deepseek-chat', 'DeepSeek V3', 5, 8, 'Frontier', null, null, null, null, '', 65536],
    ['deepseek', 'deepseek-reasoner', 'DeepSeek R1', 2, 10, 'Frontier', null, null, null, null, '', 65536],
  ];
